...
describe('buildBatchFilter', () => {
  it('prepends the sampling filter before the frame transform chain', () => {
    const filter = buildBatchFilter([1, 3, 5, 7], 128, 64, 'stretch');
